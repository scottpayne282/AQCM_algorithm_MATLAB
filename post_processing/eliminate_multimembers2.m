function [CommunityCell2]=eliminate_multimembers2(S,CommunityCell,n)

% for this version (eliminate_multimembers2) see the line with
% "labels=setdiff(labels,v);"  (should be around line 33)
% in this version we calculate contributions relative to all nodes except
% the current node. In the original version of this function we calculate
% contributions relative to non multimember nodes only
