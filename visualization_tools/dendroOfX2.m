function dendroOfX2(T,Tlabels,n,font,X)
...
z=X(n+1:nodes,1);w=X(n+1:nodes,2);
clustlabels = cellstr( num2str((n+1:nodes)') );
...
text(x,y, vertlabels, 'VerticalAlignment','top', ...
                             ...
                             'Rotation',45);
text(z,w, clustlabels, 'VerticalAlignment','bottom', ...
